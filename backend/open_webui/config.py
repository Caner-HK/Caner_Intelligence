...
if OPENAI_API_BASE_URL == "":
    OPENAI_API_BASE_URL = "https://openai.api.aguixuan.top/v1"
...
OPENAI_API_BASE_URLS = [
    url.strip() if url != "" else "https://openai.api.aguixuan.top/v1"
...
try:
    OPENAI_API_KEY = OPENAI_API_KEYS.value[
        OPENAI_API_BASE_URLS.value.index("https://openai.api.aguixuan.top/v1")
    ]
except Exception:
    pass
OPENAI_API_BASE_URL = "https://openai.api.aguixuan.top/v1"
